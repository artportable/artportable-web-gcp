...
export default function SimilarPortfoliosSection({ portfolios }) {
  ...
  return (
    <>
      <Typography style={{ marginTop: "2vh" }} variant="h4" component="h1">
      ...
      <div className={s.portfolioGrid}>
        {portfolios[0] && (
          <SimilarPortfolio data={portfolios[0]}></SimilarPortfolio>
        )}
        {portfolios[1] && (
          <SimilarPortfolio data={portfolios[1]}></SimilarPortfolio>
        )}
        {portfolios[2] && (
          <SimilarPortfolio data={portfolios[2]}></SimilarPortfolio>
        )}
      </div>
    </>
  );
