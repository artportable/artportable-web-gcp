...
export default function CheckoutFormStory({ email, fullName, storyId }) {
  ...
  function createPurchase({ customerId, paymentMethodId, storyId }) {
    return fetch(`${apiBaseUrl}/api/payments/boostStory`, {
      method: "POST",
      headers: {
        "Content-type": "application/json",
        Authorization: `Bearer ${token}`,
