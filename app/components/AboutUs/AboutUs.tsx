...
export default function AboutMe() {
  ...
  const staff = [
    ...
    {
      name: 'Erik Glitterstam',
      title: 'Art Coordinator',
      image: '/staff/artportable_erik_g.jpg',
      email: 'erik.g@artportable.com',
    },
    {
      name: 'Filippa Flood',
      title: 'Journalist',
    ...
    {
      name: 'Fredrik Mannelqvist',
      title: '',
      image: '/staff/artportable_grey.jpg',
      email: 'fredrik@artportable.com',
    },
    {
      name: 'Leonard Edland',
      title: 'Art Coordinator',
    ...
    {
      name: 'Sebastian Karlholm',
      title: 'Art Coordinator',
      image: '/staff/artportable_sebastian.jpg',
      email: 'sebastian@artportable.com',
    },
    {
      name: 'Tony Lidén',
      title: 'Art Coordinator',
