...
export default function AboutMe() {
  ...
  const staff = [
    ...
    { name: "Erik Glitterstam", title: "", image: '/staff/artportable_grey.jpg', email: "erik.g@artportable.com" },
    { name: "Fredrik Mannelqvist", title: "", image: '/staff/artportable_grey.jpg', email: "fredrik@artportable.com" },
    { name: "Leonard Edland", title: "", image: '/staff/artportable_grey.jpg', email: "leonard@artportable.com" },
    ...
    { name: "Sebastian Karlholm", title: "", image: '/staff/artportable_grey.jpg', email: "sebastian@artportable.com" },
