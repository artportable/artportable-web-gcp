...
export default function ProfileCard({ userProfile, userProfilePicture, onUpdateProfilePicture = null, hideAddBtn = false, divider = false, isMyProfile = false, linkToProfile = true }) {
  const s = styles();
      ...
      <CardContent>
        <div className={s.cardData}>
         ...
         <Box className={s.counterBox}>
           ...
           />
           <Button onClick={() => setFollowingOpen(true)} className={s.followersButton}>
             <Typography variant="body2" display="block">
               {data?.Followers}
             </Typography>
             <Typography variant="caption" display="block">
