...
const DiscoverDigitalTab = memo((props: DiscoverHighLightsTabProps) => {
  ...
  const { data: artworks, isLoading: isLoadingArtWorks } =
    useInfiniteScrollWithKey<Artwork>(
      ...
      (pageIndex, previousPageData) => {
        ...
        if (pageIndex == 0) {
          let url = new URL(`${apiBaseUrl}/api/Discover/artworks/digital`);
...
export default DiscoverDigitalTab;
