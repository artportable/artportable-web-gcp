...
import CheckoutFormStory from "../app/components/CheckoutForm/CheckoutFormStory";

export default function BoostStory(props) {
        ...
        <div className={s.fullContainer}>
          <div className={s.container}>
            ...
            <div className={s.downMobile}>
              ...
              <div className={s.priceNow}>{t("priceNowStory")}</div>
              <div
                style={{
                  display: "flex",
...
export async function getServerSideProps({ locale, query }) {
  ...
  const storyId = Object.keys(query)[0] || null;

  if (!storyId) {
    return { props: { error: "Story ID is missing", locale } };
  }
