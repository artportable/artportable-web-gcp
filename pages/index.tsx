          ...
          <div className={s.discoverContainer}>
            ...
            <Box paddingTop={4}>
              ...
              >
                ...
                <div
                  style={{
                    backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.1), rgba(0, 0, 0, 0.1)), url("https://artportableprod.blob.core.windows.net/artportable-prod/images/cd99b4ca-e1b2-4c8b-a8f5-4a459ac3b5a2.jpg")`,
                    backgroundSize: "cover",
                    backgroundRepeat: "repeat",
                    backgroundPosition: "left",
                    position: "relative",
                ...
                <div
                  style={{
                    backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.1), rgba(0, 0, 0, 0.1)), url("https://artportableprod.blob.core.windows.net/artportable-prod/images/8b9dbcea-9d75-4ae5-9bb3-45f5490faa60.jpg")`,
                    backgroundSize: "cover",
                    backgroundRepeat: "repeat",
                    backgroundPosition: "left",
                    position: "relative",
